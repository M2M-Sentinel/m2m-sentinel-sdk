...
class X402SignerClient:
    def __init__(self, private_key=None, base_url="https://m2msentinel.vercel.app", timeout=30):
    ...
    def sign_authorization(self, challenge):
        ...
        pay_to = challenge.get("payTo") or challenge.get("recipient") or "0x8b317cc0e6a8eefee67bfef7fd18d4076735e5d3"
